...
#define TASK_THREAD_RA 3224 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 3232 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 3240 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 3248 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 3256 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 3264 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 3272 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 3280 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 3288 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 3296 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 3304 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 3312 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 3320 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 3328 /* offsetof(struct task_struct, thread.s[11]) */
...
#define TASK_THREAD_F0 3336 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 3344 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 3352 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 3360 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 3368 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 3376 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 3384 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 3392 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 3400 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 3408 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 3416 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 3424 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 3432 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 3440 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 3448 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 3456 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 3464 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 3472 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 3480 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 3488 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 3496 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 3504 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 3512 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 3520 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 3528 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 3536 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 3544 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 3552 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 3560 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 3568 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 3576 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 3584 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 3592 /* offsetof(struct task_struct, thread.fstate.fcsr) */
#define TSK_STACK_CANARY 1528 /* offsetof(struct task_struct, stack_canary) */
...
#define KVM_ARCH_HOST_SSCRATCH 48 /* offsetof(struct kvm_vcpu_arch, host_sscratch) */
#define KVM_ARCH_HOST_STVEC 56 /* offsetof(struct kvm_vcpu_arch, host_stvec) */
#define KVM_ARCH_HOST_SCOUNTEREN 64 /* offsetof(struct kvm_vcpu_arch, host_scounteren) */
